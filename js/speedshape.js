...
function setmode(newmode, newgame){
    ...
    // main menu mode
        ...
        get('page').innerHTML = '<div style="border-right:8px solid #222;display:inline-block;text-align:left;vertical-align:top"><div class=c><b>Speedshape</b></div><hr><div class=c><a onclick="setmode(1, 1)">Start New Game</a></div><hr><div class=c><input id=reds size=1 value='
